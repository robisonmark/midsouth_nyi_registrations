...
CREATE TABLE IF NOT EXISTS addresses (
    ...
    administrative_area_level VARCHAR(100) NOT NULL,

    created_at TIMESTAMP NOT NULL,          -- BaseEntity field
    created_by VARCHAR(255) NOT NULL,       -- BaseEntity field
    updated_at TIMESTAMP,                   -- BaseEntity field
    updated_by VARCHAR(255),                -- BaseEntity field
    version INT NOT NULL,                  -- BaseEntity field
    entity_data TEXT                        -- BaseEntity field
);
