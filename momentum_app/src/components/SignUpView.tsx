...
export default function SignUpView() {
  ...
  useEffect(() => {
    dispatch(setHeaderSubText(selectedCategory));
  }, [dispatch]); // Empty dependency array ensures it runs only once on mount

  useEffect(() => {
    let current_category:string = `Art | ${category}`
    dispatch(setHeaderSubText(current_category));
